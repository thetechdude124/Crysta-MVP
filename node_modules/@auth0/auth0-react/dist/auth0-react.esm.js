...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new xi(toAuth0ClientOptions(clientOpts)); })[0];
...
export { Auth0Context, Auth0Provider, ri as InMemoryCache, ni as LocalStorageCache, OAuthError, Ci as User, useAuth0, withAuth0, withAuthenticationRequired };
